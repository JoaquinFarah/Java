...
public class EJ12Main {
    ...
    public static void main(String[] args) {
        ...
        EJ12Servicio servicio = new EJ12Servicio();
        
        servicio.crearPersona();
        servicio.calcularEdad();
        
        System.out.println("Edad para saber si es mayor o menor?");
        int comp= leer.nextInt();
        servicio.menorQue(comp, edad);
